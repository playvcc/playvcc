...
(function(){
  ...
  function showLocked(){
    adminLockScreen.classList.remove('admin-hidden');
    adminPageContent.classList.add('admin-hidden');
  }

  function showUnlocked(){
    adminLockScreen.classList.add('admin-hidden');
    adminPageContent.classList.remove('admin-hidden');
  }
