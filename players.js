// VCC Players Page Custom PFP Display Fix
...
(function(){
  ...
  function filterPlayers(){
    ...
    return players.filter(p => {
      ...
      if(rank && rank !== 'all ranks' && rank !== 'all' && (p.rank || '').toLowerCase() !== rank) return false;
      if(platform && platform !== 'all platforms' && platform !== 'all' && (p.platform || '').toLowerCase() !== platform) return false;
