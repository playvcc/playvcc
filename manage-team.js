// VCC Manage Team compatibility fix: supports user_id/player_id and invite messages.
    ...
    try{
      ...
      membersBox.innerHTML = members.length ? members.map(m => `
        <div class="identity-row">
          <span>${safe(m.profiles?.display_name || m.profiles?.username || m.user_id || m.player_id)}</span>
