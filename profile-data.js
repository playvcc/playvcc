// VCC Profile Data PFP Display Fix
// Loads correct player profile and fixes broken PFP display.
...
(async function(){
  ...
  function fixAllProfileImages(src){
    [
      'profileAvatar',
      'profilePreview',
      'avatarPreview',
    ...
    document.querySelectorAll('.player-avatar, .profile-avatar img, img[data-profile-avatar]').forEach(img => {
      img.onerror = () => {
        img.onerror = null;
